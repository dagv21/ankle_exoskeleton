#include <stdint.h>
#include "ankle_exoskeleton/feature_extractor.hpp"
#include "ankle_exoskeleton/gait_cycle_classifier.hpp"
#include "ros/ros.h"
#include <std_msgs/Int8.h>
#include <ankle_exoskeleton/IMUData.h>
#include <cstdlib>
#include <iostream>
#include <string>
...
void callback(const ankle_exoskeleton::IMUData imu_data){
...
int main(int argc, char** argv){
  ...
  ros::Subscriber sub = n.subscribe("imu_data/foot", 1000, callback);
